...
export default function App() {
  ...
  const [mainTab, setMainTab] = useState('hortas');
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.tabBar}>
        <TouchableOpacity
          style={[styles.tabButton, mainTab === 'hortas' && styles.tabButtonActive]}
          onPress={() => switchTab('hortas')}
        >
          <MaterialIcon name="eco" size={28} color={mainTab === 'hortas' ? '#27AE60' : '#999'} />
          <Text style={[styles.tabLabel, mainTab === 'hortas' && styles.tabLabelActive]}>
            Minhas Hortas
          </Text>
        </TouchableOpacity>

        <TouchableOpacity
          style={[styles.tabButton, mainTab === 'calendario' && styles.tabButtonActive]}
        ...
        >
          ...
          />
          <Text style={[styles.tabLabel, mainTab === 'calendario' && styles.tabLabelActive]}>
            Cronograma
          </Text>
        </TouchableOpacity>
      </View>
