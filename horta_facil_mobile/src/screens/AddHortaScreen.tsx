...
const AddHortaScreen = ({ navigation }: { navigation: Navigation }) => {
  ...
  const handleSalvar = async () => {
    ...
    try {
      ...
      Alert.alert('Erro', error?.message ?? 'Erro ao criar horta');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.footerText}>Todos os campos com * são obrigatórios</Text>
      </ScrollView>
    </View>
  );
};
